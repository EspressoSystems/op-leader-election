...
func (_RoundRobinLeaderElection *RoundRobinLeaderElectionTransactor) Submit(opts *bind.TransactOpts, _batch []byte) (*types.Transaction, error) {
	return _RoundRobinLeaderElection.contract.Transact(opts, "submit", _batch)
}

// Submit is a paid mutator transaction binding the contract method 0xef7fa71b.
//
// Solidity: function submit(bytes _batch) returns()
func (_RoundRobinLeaderElection *RoundRobinLeaderElectionSession) Submit(_batch []byte) (*types.Transaction, error) {
	return _RoundRobinLeaderElection.Contract.Submit(&_RoundRobinLeaderElection.TransactOpts, _batch)
}

// Submit is a paid mutator transaction binding the contract method 0xef7fa71b.
//
// Solidity: function submit(bytes _batch) returns()
func (_RoundRobinLeaderElection *RoundRobinLeaderElectionTransactorSession) Submit(_batch []byte) (*types.Transaction, error) {
	return _RoundRobinLeaderElection.Contract.Submit(&_RoundRobinLeaderElection.TransactOpts, _batch)
}
